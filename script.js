...
// WalletConnect v2 ile Web3Modal bağlantısı
const provider = new window.Web3ModalStandalone.default({
  projectId: "3c1933cfa3a872a06dbaa2011dab35a2", // senin WalletConnect project ID
...
document.getElementById('connectWalletBtn').addEventListener('click', async () => {
  try {
    ...
    console.error("İmza reddedildi:", error);
    alert("Cüzdan bağlantısı veya imza işlemi reddedildi.");
  }
});
